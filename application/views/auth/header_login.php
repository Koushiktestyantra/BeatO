...
<div class="wrapper" style="background-color: rgb(239 239 239);">
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="margin: auto;">
       <!-- Left navbar links -->
    <ul class="navbar-nav" >
      
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">BeatO</a>
      </li>
